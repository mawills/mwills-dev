          ...
          <section id="experience" className="mb-4">
            ...
            <section className="mb-3">
              ...
              <ul className="list-inside list-disc space-y-1 pl-6">
                <li>Tech lead for numerous projects with direct client impact e.g. reducing page load time on high-traffic pages ~2 seconds and trusted to resolve high-priority production bugs.</li>
                <li>Built features using PHP, Angular, AWS, and CircleCI, such as a credit payment experience, an email referral service, and services to automate work for bankers and for clients to more easily access loan information.</li>
                <li>Mentored new developers, assisted with onboarding and troubleshooting, and had regular meetings to listen to their feedback and questions about our processes, code, and their career goals.</li>
              </ul>
            </section>
            <section className="mb-3">
              ...
              <ul className="list-inside list-disc space-y-1 pl-6">
                <li>Refactored and built new features for two React applications, using Typescript, React, and the Gatsby framework.</li>
                <li>Built the CI / CD pipeline from scratch in Jenkins, including separate hosted environments for each pull request. Improved security practices by setting up CI to securely inject secrets.</li>
                <li>Implemented language internationalization (i18n) and drove initiatives for other accessibility-related improvements.</li>
              </ul>
            </section>
            <section className="mb-3">
              ...
              <ul className="list-inside list-disc space-y-1 pl-6">
                <li>Responsible for REST & GraphQL APIs serving an average of 55k requests per minute, using AWS (api gateway, load balancer), PHP, and MySQL.</li>
                ...
                <li>Refactored legacy PHP frontend project into a React application with object-oriented code and a focus on keeping 100% test coverage.</li>
                <li>Tech stack also provided experience with migrating on-prem services to AWS, as well as Jenkins, Docker, Microsoft Azure, SumoLogic, NewRelic, and Salesforce.</li>
              </ul>
            </section>
            <section className="mb-3">
